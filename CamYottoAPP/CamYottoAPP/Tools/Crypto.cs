...
namespace CamYottoAPP.Tools
{
    public class Crypto
    {
        ...
        string LlavePersonalizadaAPI = "APiklsjdnflkfdf90rer83722";
        ...
        public string DesEncriptarPassword(string Pass)
        {
            ...
            using (TripleDESCryptoServiceProvider tripleDESCryptoService = new TripleDESCryptoServiceProvider())
            {
                ...
                {
                    Byte[] byteHash = hashMD5Provider.ComputeHash(Encoding.UTF8.GetBytes(LlavePersonalizadaApp));
